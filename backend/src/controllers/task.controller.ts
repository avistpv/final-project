...
const assignIfDefined = <T, K extends keyof T>(
  ...
  if (value !== undefined && value !== null) {
    ...
    (target as any)[key] = transform
      ? transform(value as NonNullable<T[K]>)
      : value;
  }
};

const convertRequestBodyToCreateInput = (
  ...
  assignIfDefined(input, "deadline", body.deadline, String);

  return input;
};

const convertRequestBodyToUpdateInput = (
  body: TaskRequestBody,
): TaskUpdateInput => {
